...
public class TestUtil {
    public WebDriver driver; // публичен е, за да можем да си го достъпваме, където ни трябва.
    private String url;
    ...
    private void setupBrowserDriver(){
        try (FileInputStream configFile = new FileInputStream("src/test/resources/config.properties")){
            ...
            browser = config.getProperty("browser2");
        ...
        switch (browser){
            ...
            case "firefox":
                ...
                break;
            default:
                throw new IllegalCallerException("Unsupported browser");
        }
